                                    ...
                                    <Card className="align-baseline h-full col-span-1 md:text-primary-900  bg-[#F3F5F8]">
                                        <CardBody className="sm:w-full md:my-auto h-full mx-auto bg-[#F3F5F8] p-12">
                                            <div className="flex flex-col shadow-xl  p-10 md:px-20 pr-10 max-w-[600px] mx-auto h-full px-auto justify-center content-center align-center">
                                                ...
                                                <p className="text-black sm:text-xs md:text-xl font-postbody md:text-base md:w-full mx-auto  text-justify max-w-xs sm:max-w-full"> Organisasi non-profit di bidang konservasi sumber daya alam ingin membangkitkan kembali budaya hidup harmoni antara manusia, alam dan satwa liar di Pulau Jawa.
