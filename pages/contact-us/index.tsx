        ...
        <CardGroup className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 m-20 mx-auto  p-10 sm:px-20 py-10 mt-5 w-full">
          ...
          <div>
            <div className="align-top">
              <h1 className="text-black text-left m-0 max-w-xs text-2xl font-bold sm:max-w-full drop-shadow-xl">
                KANTOR PUSAT
              </h1>
              ...
              <div className="grid  col-span-1 gap-0 w-full md:w-1/2 items-left mt-3  md:items-center grid-cols-4">
                ...
                <Link
                  className="drop-shadow-xl grid col-span-1 my-5"
          ...
          <iframe
            className="shadow-xl"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.7704356898225!2d110.35142947476626!3d-7.81410799220644!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7af61d0254a0db%3A0xc44af8788fff1217!2sJawi%20(Javan%20Wildlife%20Institute)!5e0!3m2!1sid!2sid!4v1711173804931!5m2!1sid!2sid"
            width="100%"
            height="150%"
          ></iframe>
