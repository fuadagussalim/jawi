      ...
      <NavigationMenuList>
        <NavigationMenuItem>
          <Link href="/" legacyBehavior passHref>
            <NavigationMenuLink className={`${navigationMenuTriggerStyle()} tracking-wider hover:text-orange`}>
              HOME
            </NavigationMenuLink>
          </Link>
        </NavigationMenuItem>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuTrigger className={`${navigationMenuTriggerStyle()} tracking-wider hover:text-orange`}>ABOUT</NavigationMenuTrigger>
          <NavigationMenuContent>
