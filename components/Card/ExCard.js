    ...
    return (
       ...
       cardDatasObject.map(( cardData , index) => (
          ...
          {(index+1) % 2 === 0 ? (
            ...
            <>
            <CardImage src={cardData?.image} className='gridcol-span-1  h-64 sm:block md:hidden' imageClassName={' object-cover objet-bottom'} alt={''} />
                                                 <Card className="grid md:mt-20  md:py-10 h-full rounded-none  sm:mb-10 md:mb-0 col-span-1 align-middle text-primary-400">
                                                     <CardBody className="flex align-middle h-full items-center align-center bg-[#F3F5F8] m-10">
                                                         <div className="w-full sm:pt-5  rounded-0">
                                                             <div>
                                                                 ...
                                                                 <h3 className="text-black mb-5 w-full text-center m-0 text-base font-extrabold">{cardData.title}</h3>
                                                                  <div
                                                                className={'text-black  font-postbody  sm:text-justify md:text-center sm:text-xs md:text-base w-2/3 mx-auto'}
                                                                dangerouslySetInnerHTML={{ __html: cardData?.excerpt??<p></p> }}
                                                                />
                                                                </div>
                                                 ...
                                                 <CardImage src={cardData.image} className='gridcol-span-1  md:mt-20  h-64 sm:hidden md:block h-[330px]' imageClassName={' object-cover objet-bottom'} alt={''} />
