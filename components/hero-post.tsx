...
export default function HeroPost({
  ...
  return (
    <section>
      ...
      <PostpageBanner
        image={coverImage?.node.sourceUrl}
        maintext={""}
        subtext={""}
        className=""
      />
      
      <div className="md:grid md:grid-cols-5 md:gap-x-25 lg:gap-x-30 mt-10 sm:px-10 md:px-40">
        <div className="md:grid col-span-2  md:pr-10">
        ...
        <div className="grid md:col-span-3 sm:mt-10">
          <div
